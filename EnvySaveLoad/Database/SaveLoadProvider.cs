...
namespace EnvySaveLoad.Database
{
    public class SaveLoadProvider
    {
        ...
        {
            this.ItemStorage = new DataStorage<List<Loadout>>(EnvySaveLoadPlugin.Instance.Directory, "Database.json");
        }
